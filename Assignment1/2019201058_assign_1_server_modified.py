...
def generateSharedKey(full_msg,clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1):
...
def generatePublicKey(d1):
   
    d1_pubkey = d1.gen_public_key()
    return d1_pubkey
    

def keyExchangeProcess(clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1):
    
    print('entered inside key exchange process')
    publicKey=generatePublicKey(d1)
...
def splitFilePath(full_msg,clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1):
...
#        fileNameGloabal=file_path
    ...
    keyExchangeProcess(clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1)
    return     
...
def  opCodeAction(opCodeVerify,full_msg,clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1):
#    global fileNameGloabal
#    global sharedKeyGlobal
    if opCodeVerify == 20 :
        splitFilePath(full_msg,clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1)
    elif opCodeVerify == 10 :
        print("public key of client received")
        sharedKey=generateSharedKey(full_msg,clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1)
        print('shared key is')
        print(sharedKey)
        print(fileNameGloabal[0])
...
#        sharedKeyGlobal=sharedKey
        ...
        sendDataToClient(clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1)
    return    

def client_handle(clientsocket , address, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1):
...
def sendDataToClient(clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1):
#    global sharedKeyGlobal
#    global fileNameGloabal
...
def clientFunction(clientsocket):
    ...
    client_handle(clientsocket , address, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1)
    while True:
        full_msg=''
        ...
        print(full_msg)
        opCodeVerify=int(full_msg[4:6])
        opCodeAction(opCodeVerify,full_msg,clientsocket, sharedKeyGlobal,fileNameGloabal, keyToEncrypt,cipher_encrypt,d1)
        print(opCodeVerify)
    clientsocket.close()
